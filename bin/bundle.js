...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsBooksListJs = __webpack_require__(159);

	var _componentsBooksListJs2 = _interopRequireDefault(_componentsBooksListJs);

	__webpack_require__(165);

	var _actionsBookJs = __webpack_require__(166);
	...
	var _reducersIndexJs = __webpack_require__(178);

	var _reducersIndexJs2 = _interopRequireDefault(_reducersIndexJs);

	var _reactRedux = __webpack_require__(179);

	var _appJs = __webpack_require__(190);

	var _appJs2 = _interopRequireDefault(_appJs);

	var store = (0, _redux.createStore)(_reducersIndexJs2['default'], (0, _redux.applyMiddleware)(_reduxThunk2['default']));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BookJs = __webpack_require__(160);

	var _BookJs2 = _interopRequireDefault(_BookJs);
	...
	var BooksList = (function (_React$Component) {
	  ...
	  function BooksList() {
	    ...
	    _get(Object.getPrototypeOf(BooksList.prototype), 'constructor', this).apply(this, arguments);
	  }
	    ...
	    value: function render() {
	      ...
	      var books = this.props.list.map(function (book) {
	        return _react2['default'].createElement(
	          ...
	          { key: book.key },
	          ' ',
	          _react2['default'].createElement(_BookJs2['default'], { info: book }),
	          ' '
	        );
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.booksLoading = booksLoading;
	exports.booksLoaded = booksLoaded;
	exports.asycLoadBooks = asycLoadBooks;
	...
	function asycLoadBooks() {
	  return function (dispatch) {

	    dispatch(booksLoading());

	    fetch('/books.json').then(function (result) {
	      return result.json();
	    }).then(function (data) {
...
/***/ function(module, exports) {
	...
	function booksApp(state, action) {
	  ...
	  if (action.type === 'BOOKS' && action.status === 'LOADING') return Object.assign({}, state, {
	    books: { status: 'LOADING', list: [] }
	  });else if (action.type === 'BOOKS' && action.status === 'LOADED') return Object.assign({}, state, { books: { status: 'LOADED', list: action.list } });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _containersHeaderJs = __webpack_require__(191);

	var _containersHeaderJs2 = _interopRequireDefault(_containersHeaderJs);

	var _componentsBooksListContainerJs = __webpack_require__(194);

	var _componentsBooksListContainerJs2 = _interopRequireDefault(_componentsBooksListContainerJs);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        null,
	        _react2['default'].createElement(_containersHeaderJs2['default'], null),
	        _react2['default'].createElement(_componentsBooksListContainerJs2['default'], null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsHeaderJs = __webpack_require__(192);
	...
	var AppHeader = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_componentsHeaderJs2['default']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavigationBarJs = __webpack_require__(193);

	var _NavigationBarJs2 = _interopRequireDefault(_NavigationBarJs);
	  ...
	  _createClass(Header, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_NavigationBarJs2['default'], null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BooksListJs = __webpack_require__(159);

	var _BooksListJs2 = _interopRequireDefault(_BooksListJs);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
	  return {
	    loadBooks: function loadBooks() {
	      return dispatch((0, _actionsBookJs.asycLoadBooks)());
	    }
	  };
	};

	var BooksListContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_BooksListJs2['default']);

	exports['default'] = BooksListContainer;
	module.exports = exports['default'];
